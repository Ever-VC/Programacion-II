...
{
    public class BoletoEconomico : BoletoAbst
    {
        public BoletoEconomico()
        {
            //---Bloque para generar el ID, para la clase de Boleto Económico se van a generar de 100 hasta 300 de forma aleatoria
            Random r = new Random();//Genera un número ramdom
            int id = r.Next(101-1, 299+1);//Almacena el número ela variable ID
            setId(id);//Mandamos el ID generado

            //---Asignamos el tipo de voleto automáticamente
            this.tipoBoleto = "Boleto Economico";
        ...
        public override void setDescripcion()//Le pedimos que inserte el destino del viaje para generar una breve descripción
        {
            ...
            this.descripcion = "Boleto de Clase Economica con destino a "+destino;
        }
