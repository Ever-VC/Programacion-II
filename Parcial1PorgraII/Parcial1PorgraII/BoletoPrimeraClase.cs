...
{
    internal class BoletoPrimeraClase : BoletoAbst
    {
        public BoletoPrimeraClase()
        {
            //---Bloque para generar el ID, para la clase de Boleto Ejecutivo se van a generar de 600 hasta 900 de forma aleatoria
            Random r = new Random();//Genera un número ramdom
            int id = r.Next(601-1, 899+1);//Almacena el número ela variable ID
            setId(id);//Mandamos el ID generado

            //---Asignamos el tipo de voleto automáticamente
            this.tipoBoleto = "Boleto de Primera Clase";
        ...
        public override void setDescripcion()//Le pedimos que inserte el destino del viaje para generar una breve descripción
        {
            ...
            this.descripcion = "Boleto de Primera Clase con destino a "+destino;
        }
